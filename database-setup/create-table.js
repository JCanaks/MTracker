...
pool.connect((error, client, done) => {
  ...
  client.query('CREATE TABLE userAccount( "userId" serial PRIMARY KEY NOT NULL, "userFullname" text NOT NULL, role text NOT NULL,"userPassword" character(60) NOT NULL, department text NOT NULL, "userEmail" text NOT NULL, "userPhonenumber" text NOT NULL)', (queryError) => {
    done();
    if (queryError) {
