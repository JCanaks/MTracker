function approveRequest() {
  ...
  console.log(options);
  const request = new Request(`/api/v1/requests/${Number(requestId[1])}/approve`, options);
  fetch(request)
...
function disapproveRequest() {
  ...
  console.log(options);
  const request = new Request(`/api/v1/requests/${Number(requestId[1])}/disapprove`, options);
  fetch(request)
...
function resolveRequest() {
  ...
  console.log(options);
  const request = new Request(`/api/v1/requests/${Number(requestId[1])}/resolve`, options);
  fetch(request)
